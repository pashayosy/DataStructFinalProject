...
public class UniqueIndex<TKey, TValue> : IIndex<TKey, TValue>, IEnumerable<TValue>
{
    ...
    public IEnumerable<TValue> Get(TKey key) => index.TryGetValue(key, out TValue? value) ? new IEnumerable<TValue>(value) : throw new ArgumentException($"Value with this key {key} is not exist");
