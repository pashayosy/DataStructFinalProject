...
databaseEngine.CreateRangeIndex<int>("Id", (person) => person.Id);

databaseEngine.GetRecordByUniqueIndex<int>("Id", 1);
databaseEngine.GetRecordsByNonUniqueIndex<string>("Name", "Tiker");
databaseEngine.GetRecordsByRangeIndex<int>("Id", 3);